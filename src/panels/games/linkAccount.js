      ...
      <SimpleCell
        ...
        Игры
          ...
          <Placeholder
            ...
            action={<Button size="l" target={'_blank'} href={`https://hacaton4.creativityprojectcenter.ru/cyber_mini_apps/steam_auth.php?login&${qs.stringify(ui.start_data)}`}>Привязать аккаунт</Button>}
          >
