...
class LightOpenID
{
    ...
    function __construct($host, $proxy = null)
    {
        ...
        $sign_params_query = http_build_query($_GET);
        $this->returnUrl = 'https://hacaton4.creativityprojectcenter.ru/cyber_mini_apps/steam_auth_return.php?'.$sign_params_query;
